...
class CreateExistsPage extends StatefulWidget {
  final String productId;
  const CreateExistsPage({
    super.key,
    required this.productId,
  });

  @override
  State<CreateExistsPage> createState() => _CreateExistsPageState();
}

class _CreateExistsPageState extends State<CreateExistsPage> {
  Stock? selectedStock;
  ...
  Widget build(BuildContext context) {
    final outputsProvider =
        Provider.of<OutputsProvider>(context, listen: false);
