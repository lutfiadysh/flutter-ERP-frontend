...
import 'dropdown_item.dart' as item;
...
class DropdownRoute<T> extends PopupRoute<DropdownRouteResult<T>> {
  ...
  final List<item.MenuItems<T>> items;
              ...
              child: Builder(
                builder: (BuildContext context) {
                  if (scrollController == null) {
                    final item.MenuLimits menuLimits = getMenuLimits(
  ...
  item.MenuLimits getMenuLimits(Rect buttonRect, double availableHeight, int index) {
    ...
    return item.MenuLimits(menuTop, menuBottom, menuHeight, scrollOffset);
  }
}
...
class _DropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    final item.MenuLimits menuLimits =
