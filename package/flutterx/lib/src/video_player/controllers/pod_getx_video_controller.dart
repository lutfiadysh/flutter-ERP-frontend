...
import 'package:flutterx/src/video_player/models/overlay_options.dart';
...
import 'package:flutterx/src/video_player/utils/logger.dart';
import 'package:flutterx/src/video_player/utils/video_apis.dart';
...
class PodGetXVideoController extends _PodGesturesController {
  ...
  Color controllIconsColor = Colors.white;
  Color durationTextColor = Colors.white;
  Color nextIconColor = Colors.white;
  Color prevIconColor = Colors.white;
  void Function()? nextVideoTap = () {};
  void Function()? prevVideoTap = () {};
  void config({
